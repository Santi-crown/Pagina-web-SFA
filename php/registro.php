...
<body>
    ...
    <header>
        ...
        <section class="textos-header">
            <h1>SCIENTUS</h1>
            <img src="../img/logo scientus.svg" alt="" class="logo">
            <h2><i>"El tiempo es la cosa más valiosa que una persona puede gastar". <br>-Theophrastus </i></h2>
        </section>
            ...
            <div class="form">
                ...
                <div class="grupo">
                    ...
                    <select class="select1" name="tipo_documento" id="tipo_documento" required>
                        ...
                        <option value="TI" style="color: black;">Permiso especial de permanencia</option>
